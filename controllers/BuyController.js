...
// ✅ Initialize Resend
const resend = new Resend('re_YKbJAoV3_8EX7Uk8gLLySjy7A7EmAzZYA'); // You can also move this to process.env.RESEND_API_KEY
...
export const buysell = async (req, res) => {
  try {
    ...
    if (
      !buySell || !name || !phone || !email ||
      !dropOffLocation || !country || !timing || !expectedDate
    ) {
