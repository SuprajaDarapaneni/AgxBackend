...
export const submitReview = async (req, res) => {
  try {
    ...
    await resend.emails.send({
      from: "AGX Reviews <onboarding@resend.dev>",
      to: adminEmail,
    ...
    const customerEmailHtml = `
      ...
      <ul>
        ...
        <li><strong>Comment:</strong><br>${cleanComment}</li>
      </ul>
    ...
    console.log(`📧 Thank-you email sent to customer: ${cleanEmail}`);

    return res.status(201).json({ message: "Review submitted and emails sent." });
  } catch (error) {
