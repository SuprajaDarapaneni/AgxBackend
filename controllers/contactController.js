...
const resend = new Resend("re_YKbJAoV3_8EX7Uk8gLLySjy7A7EmAzZYA");
...
export const submitContactForm = async (req, res) => {
  try {
    ...
    // Admin email content
    const adminEmail = process.env.EMAIL_SEND || "info@agx-international.com";
    ...
    // Confirmation email content for customer
    const customerEmailHtml = `
      <h2>Thank You for Your Message</h2>
      <p>Dear ${cleanName},</p>
      <p>Thank you for contacting AGX International. We have received your message and will get back to you shortly.</p>
      ...
      <p>If your inquiry is urgent, contact us at <a href="mailto:info@agx-international.com">info@agx-international.com</a>.</p>
      <p>Best regards,<br><strong>AGX International Team</strong></p>
    `;

    console.log("📧 Sending confirmation email to customer:", cleanEmail);
    await resend.emails.send({
      from: "AGX International <onboarding@resend.dev>",
      to: cleanEmail,
    ...
    console.error("❌ Contact form error:", error.stack || error);
